...
;(function ($) {
	...
	prty = { 
        ...
        settings: { 
            //FLICKR API KEY
            Key: '6ab1c24194d653d741906c4d8113b5f6',
            //Secret
            Secret: '8324d51ded03b3f0',
            //FLICKR user ID
            User: '122537468@N08',
            //Flickr PhotoSet ID
            PhotoSet: '72157690834602976',
            /*-- VIEWBOX SETTINGS --*/ 
          ...
          //Flickr API  
            flickr.photos.getInfo({
                ...
                if(!err) {
                    ...
                    prty.vbDetails.contents().remove().addBack().append('<div class="date"><span>'+pDate.day+' '+pDate.month+', '+pDate.year+'</span></div>');
